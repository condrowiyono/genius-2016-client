...
<div class="didalamnya">
	 ...
	 <h2>Simulasi Penyisihan Online GENIUS 2016 <a class="tombol" href="index.php" style='position:absolute;Top:5px;right:5px;'>Kembali</a> </h2>
</div>
</div>
...
<!-- CODE HERE -->
		...
		<div>
			<div>
				...
				$query2 = "SELECT * FROM tbsimulasi where email ='".$email."'";
