...
<div class="didalamnya">
	<h2>Simulasi Penyisihan Online GENIUS 2016</h2>
</div>
</div>
...
<!-- BAGIAN INTI SIDEBAR DAN PERTANYAAN -->
	...
	<div id="dalam">
		<div class="didalamnya">
				...
				if ($page=='1') {
						$query2 = "select * from tbsoalsimulasi ORDER BY indeks ASC LIMIT 0,10";
					} else if ($page=='2') {
						$query2 = "select * from tbsoalsimulasi ORDER BY indeks ASC LIMIT 10,10";
					} else if ($page=='3') {
						$query2 = "select * from tbsoalsimulasi ORDER BY indeks ASC LIMIT 20,10";
					} else if ($page=='4') {
						$query2 = "select * from tbsoalsimulasi ORDER BY indeks ASC LIMIT 30,10";
					} else {
						$query2 = "select * from tbsoalsimulasi ORDER BY indeks ASC LIMIT 0,10";
					}
				...
				?>
						...
						<div class="section group" id="<?php echo $row['indeks']; ?>">
							...
							<div class="col u0">
								...
								<?php 
								    //SQL nya
								    $query3 = "select * from tbsimulasi where email='".$_SESSION['email']."'";
			...
			<!-- akhir -->
			<a class="tombol" href="?page=4">Akhir</a>
