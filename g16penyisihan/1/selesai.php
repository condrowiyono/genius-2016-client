...
<html>
    ...
    <!-- definisikan judul -->
    <title>Log Out | GENIUS 2016</title>
...
<body>
<div class="tiket" >
	<div class="judul border"> BERHASIL </div>
	<div class="isi"> Selamat anda telah menyelesaikan Penyisihan GENIUS 2016 dengan baik. <br />
			  Semoga lancar di GENIUS 2016 !!! Genbatte! Jangan lupa isi kuisioner kami</div>
			  <br>
	<div class="tengah"><a class="tombol" href="../../set.logout.php"> Log Out </a></div>
</div>
