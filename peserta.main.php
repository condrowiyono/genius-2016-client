...
<html lang="en">
  <head>
    ...
    <title>Data Peserta | GENIUS 2016</title>
    <!-- Bootstrap core CSS -->
...
<h1>Segera Lengkapi Data Anda</h1>
<div style="margin:20px;">
<div class="row">
      <iframe class="col-sm-3 col-md-6 col-lg-6" src="datapeserta.php" width="100%" height="1570px" scrolling="no" frameborder="0"></iframe>
      <iframe class="col-sm-9 col-md-6 col-lg-6" src="jalurpenyisihan.php" width="100%" height="500px" scrolling="no" frameborder="0"></iframe>
      <iframe class="col-sm-3 col-md-6 col-lg-6" src="bukti.php" width="100%" height="660px" scrolling="no" frameborder="0"></iframe>
      <iframe class="col-sm-9 col-md-6 col-lg-6" src="potoprofil.php" width="100%" height="570px" scrolling="no" frameborder="0"></iframe>
</div>
</div>
</div>
